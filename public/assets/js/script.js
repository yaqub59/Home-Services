...
(function ($) {
	...
	// Function to update the name indexes for all service rows
	function updateIndexes() {
		$('#services-wrapper .service-row').each(function (index) {
		...
		var html = `
            <div class="form-row align-items-center skill-cont mb-2 expertise-row">
                <div class="input-block col-lg-10">
                    ...
                    <input type="text" class="form-control" name="tags[0][tags]" placeholder="Enter expertise tag">
                </div>
                <div class="input-block col-lg-1 mb-0 d-flex align-items-end">
                    <a href="javascript:void(0);" class="btn trash-icon remove-exp" title="Remove Tag">
